...
coroNET is one physical device with two firmware generations. coroNET OS 1 established the product and powers the community installation shown here. [coroNET OS 2](https://github.com/AlphaStudioDE/coroNET_OS_2) is a ground-up, MIT-licensed rewrite for the same controller, enclosure, wiring, LEDs, audio, fan, and servo hardware.

This gallery celebrates builders who take coroNET beyond the original prototype and make it part of an ambitious, personal workshop system.

### Four-Tool Workshop Build

**Built and photographed by Bobby Morgan.**

Bobby's extensively customized Snapmaker installation runs coroNET OS 1 and combines a four-tool filament system, environmental monitoring, active ventilation, a servo-controlled air path, RGBW status lighting, and a dedicated touchscreen interface.
...
<p align="center">
  <img src="media/community-showcase/three-quarter-system.jpg" alt="Bobby Morgan's customized Snapmaker installation with coroNET" width="820">
</p>
...
<table>
  ...
  <tr>
    <td width="50%"><img src="media/community-showcase/led-status-bar.jpg" alt="RGBW printer status bar driven by coroNET"></td>
    <td width="50%"><img src="media/community-showcase/side-lighting.jpg" alt="Side enclosure lighting and coroNET controller"></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td colspan="2" align="center"><img src="media/community-showcase/servo-air-path.jpg" alt="Servo-controlled ventilation air path inside the printer enclosure" width="55%"></td>
  </tr>
</table>
...
To submit a build, open an issue with a short description, hardware notes, and photographs you have permission to publish. Please state how you would like to be credited.
